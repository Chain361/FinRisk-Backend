...
4. ผลจาก `search_document_text` ให้ตอบโดยอ้างเฉพาะข้อความใน chunk ที่ได้รับ + ระบุเอกสารและหน้าอย่างเป็นธรรมชาติ (เช่น "จากเอกสาร ปร.4-เดโม-001 หน้า 1" หรือ "(เอกสาร ปร.4-เดโม-001 หน้า 1)") ห้ามแสดง key-value metadata เช่น doc_type_code:, doc_no:, page_no:
